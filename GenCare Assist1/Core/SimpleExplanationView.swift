                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 30) {
                        ...
                        VStack(spacing: 20) {
                            ...
                            ExplanationDetailCard(
                                icon: "person.3.fill",
                                color: .green, // Heritage/Family usually green or earthy
                                title: "Heritage Matters",
                                description: "History from your parents plays a role. Knowing this helps us target screenings earlier than usual."
                            )
                            ...
                            ExplanationDetailCard(
                                ...
                                description: "Most risks can be managed. Your personalized plan focuses on diet and exercise to lower this probability."
                            )
                        }
                        .padding(.horizontal)
