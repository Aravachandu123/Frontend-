...
struct PastInsightsView: View {
    ...
    let insights: [InsightItem] = [
        InsightItem(title: "Moderate cardiac risk detected", description: "Analysis of latest arterial markers indicates a moderate risk level.", icon: "exclamationmark.triangle.fill", color: .red),
